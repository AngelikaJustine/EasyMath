...
//            totalcoin = totalRight + 1;
        ...
        if(NextQuestion) {
            ...
            if(totalQuestion != 10){
                ...
                View views = inflater.inflate(R.layout.alert_dialog_l4, null);
...
//                        btnQuitClicked();
                ...
                LayoutInflater inflater = LayoutInflater.from(this);
                View views = inflater.inflate(R.layout.alert_dialog_l4_next, null);
    ...
    private void unlockNextLevel() {
        ...
        editor.putInt("scoreLv4", totalQuestion);
        editor.commit();
    }
